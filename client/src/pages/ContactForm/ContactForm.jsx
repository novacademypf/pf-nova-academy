...
function ContactForm() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_nfxusdk', 'template_5ncam6y', form.current, 'LezlJegUkPK_3njsu')
      .then((response) => {
        Swal.fire({
          title: 'Éxito',
    ...
    <div id="contact" className="bg-purple-500 h-96 w-full">
      <div className="w-full flex items-center justify-center my-12">
        <div className="absolute top-40 bg-white shadow rounded py-12 lg:px-28 px-8">
          <p className="md:text-3xl text-xl font-bold leading-7 text-center text-gray-700">Contactate con nosotros</p>

          <form ref={form} onSubmit={sendEmail}>
            <div className="md:flex items-center mt-12">
              <div className="md:w-72 flex flex-col">
                <label className="text-base font-semibold leading-none text-gray-800">Nombre</label>
                <input
                  tabIndex={0}
                  type="text"
                  name="name"
            ...
            <div>
              <div className="w-full flex flex-col mt-8">
                <label className="text-base font-semibold leading-none text-gray-800">Consulta</label>
                <textarea
                  tabIndex={0}
                  role="textbox"
                  name="message"
