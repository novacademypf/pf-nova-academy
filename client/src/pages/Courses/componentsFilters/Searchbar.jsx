...
export const Searchbar = () => {
  const { handleOnChange, valueInput,dataFilter,options } = useSearchbar()

  return (
    <>
      <div className="mb-1 bg-white  flex max-w-full h-9 rounded p-1 border-[#7D5FFF] border-[1px]"  >
        <img src={lupa} alt="lupa" className="w-5" />
        <input type="text" placeholder="buscar..." name="searchBar" onChange={handleOnChange} value={options.searchBar} className="w-full border-none focus:ring-0" />
      </div>
      {/* <div
