 ...
 */
export declare type SWRFunctionStateValue<D> = (state: D | null) => D;
/**
 * Determines how a SWR mutate value looks like.
 */
export declare type SWRMutateValue<D> = null | D | CacheItem<D | undefined> | SWRFunctionStateValue<D>;
/**
...
export declare class SWR {
     ...
     */
    getWait<D = any>(key: SWRKey): Promise<D>;
    /**
